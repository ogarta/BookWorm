const IMAGE = {
    ...
    book5: require("./bookcover/book5.jpg").default,
    book6: require("./bookcover/book6.jpg").default,
    book7: require("./bookcover/book7.jpg").default,
    ...
    Error404: require("./error/404.png").default,
